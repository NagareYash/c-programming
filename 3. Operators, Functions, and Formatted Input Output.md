# Operators, Functions, and Formatted Input Output
...
**Solution**: Refer to: [number_checker.c](src/number_checker.c)
...
**Solution**: Refer to: [loan_eligibility.c](src/loan_eligibility.c)
...
**Solution**: Refer to: [bitwise_op.c](src/bitwise_op.c)
...
**Solution**: Refer to: [print_format.c](src/print_format.c)
